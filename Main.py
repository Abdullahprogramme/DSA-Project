...
# High quality image:
# user_depth = 9, MAX_DEPTH = 9, DETAIL_THRESHOLD = 3, SIZE_MULTIPLIER = 1

# Low quality image:
# user_depth = 6, MAX_DEPTH = 9, DETAIL_THRESHOLD = 10, SIZE_MULTIPLIER = 1

# Medium quality image:
# user_depth = 7, MAX_DEPTH = 9, DETAIL_THRESHOLD = 7, SIZE_MULTIPLIER = 1
