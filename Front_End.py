...
import time
import tempfile
from PyQt5.QtWidgets import QSizePolicy, QApplication, QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QFileDialog, QLabel, QProgressBar, QRadioButton
